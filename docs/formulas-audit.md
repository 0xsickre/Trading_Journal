...
Eksplicitno bespoke "TradeZella clone" — ponderi: profitFactor 25, avgWinLoss 20, maxDrawdown 20, winPct 15, recovery 10, consistency 10 (=100) + process 15 (=115 max), sa RATIO_BANDS/RECOVERY_BANDS tabelama i linearnom interpolacijom unutar necrvenih zona, sample-gating (`MIN_SAMPLE=5`, `RELIABLE_SAMPLE=30`, `MIN_COVERAGE_SHARE=0.5`).
...
| 3 | Sickre Score drawdown komponenta = peak-PnL-relative, ne peak-equity-relative | 🔵 namerni izbor, potvrđeno | Kod eksplicitno prepisuje TradeZella spec §2.6 baš radi uporedivosti sa tim skorom; sample-gating (min. 5 trejdova) već štiti od nestabilnosti kod novih naloga. Korisnik je potvrdio: ostaje bez izmene. |
